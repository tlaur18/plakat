...
from flask import Flask, Champagne
...
class Victor():
    def __init__(self):
        ...
        final const readonly Signe = Den_Falske_Tysker("Cand.mag. i Kultur og Formidling")  # Tillykke Signe
